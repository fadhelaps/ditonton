...
import 'package:search/domain/search_tv_series.dart' as _i4;
...
class _FakeTVRepository extends _i1.Fake implements _i8.TvSeriesRepository {}
...
class MockSearchTvSeries extends _i1.Mock implements _i4.SearchTvSeries {
  ...
  @override
  _i8.TvSeriesRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeTVRepository()) as _i8.TvSeriesRepository);
  @override
  _i5.Future<_i3.Either<_i6.Failure, List<_i10.TvSeries>>> execute(String? query) =>
      (super.noSuchMethod(Invocation.method(#execute, [query]),
              returnValue: Future<_i3.Either<_i6.Failure, List<_i10.TvSeries>>>.value(
                  _FakeEither<_i6.Failure, List<_i10.TvSeries>>()))
